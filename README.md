...
👉 [Öppna fullständig notebook på Kaggle](https://www.kaggle.com/code/gabrielctriana/tbe-vaccination-gct)
 ...
 **Ingen kortsiktig incidenseffekt – och det är förväntat** 
 ...
 Samtidigt fortsätter incidensen att stiga i hög takt nationellt och
 sprider sig till nya regioner – ett mönster som är förenligt med
 klimatdrivna förändringar i fästingars utbredning och aktivitetssäsong.
 Det gör att det epidemiologiska underlaget för subvention stärks
 för varje år utan åtgärd.

 **Hälsoekonomisk brytpunkt: 6,4 fall per 100 000** 
 Periodiseringsanalys av Västmanlands program ger 538 000 kr per
 förhindrat fall – under total samhällskostnad (745 000 kr, Slunge
 et al. 2022). Brytpunkten härleds via NNV (Number Needed to
 Vaccinate): vid en incidens över 6,4 per 100 000 är varje
 subventionerad dos en samhällsekonomisk vinstaffär. Den gränsen
 är redan överskriden i Mälardalen – och animationen nedan visar
 att fler regioner passerar den för varje år som går.

 ![TBE-incidens Sverige 2003–2025](figures/tbe_karta.gif) 
 *Geografisk expansion av TBE-incidensen 2003–2025. Interaktiv
 version med år-reglage finns i notebooken.*

 För regioner över brytpunkten är frågan inte om man har råd
 att subventionera – utan om man har råda att låta bli.
